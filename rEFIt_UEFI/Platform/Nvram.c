...
CONST NVRAM_DATA ResetNvramData[] = {
  ...
  //{ L"IOHibernateRTCVariables", &gAppleBootVariableGuid }, { L"boot-image",     &gAppleBootVariableGuid },
  //{ L"boot-image-key",          &gAppleBootVariableGuid }, { L"boot-signature", &gAppleBootVariableGuid },
  //{ L"boot-switch-vars",        &gAppleBootVariableGuid },

  // Clover Variables
  //{ L"Clover.BackupDirOnDestVol", &gAppleBootVariableGuid }, { L"Clover.KeepBackupLimit", &gAppleBootVariableGuid },
  //{ L"Clover.LogEveryBoot",       &gAppleBootVariableGuid }, { L"Clover.LogLineCount",    &gAppleBootVariableGuid },
  //{ L"Clover.MountEFI",           &gAppleBootVariableGuid }, { L"Clover.NVRamDisk",       &gAppleBootVariableGuid },
  //{ L"Clover.Theme",              &gAppleBootVariableGuid },

  // Non-volatile Variables
  //{ L"fmm-computer-name",    &gAppleBootVariableGuid }, { L"bluetoothActiveControllerInfo", &gAppleBootVariableGuid },
  //{ L"backlight-level",      &gAppleBootVariableGuid }, { L"bootercfg",               &gAppleBootVariableGuid },
  //{ L"csr-active-config",    &gAppleBootVariableGuid }, { L"platform-uuid",           &gAppleBootVariableGuid },
  //{ L"prev-lang:kbd",        &gAppleBootVariableGuid }, { L"security-mode",           &gAppleBootVariableGuid },
  //{ L"UIScale",              &gAppleBootVariableGuid }, { L"nvda_drv",                &gAppleBootVariableGuid },
  //{ L"SystemAudioVolumeDB",  &gAppleBootVariableGuid }, { L"SystemAudioVolume",       &gAppleBootVariableGuid },
  //{ L"install-product-url",  &gAppleBootVariableGuid }, { L"previous-system-uuid",    &gAppleBootVariableGuid },
  //{ L"AAPL,PanicInfoLog",    &gAppleBootVariableGuid }, { L"AAPL,PathProperties0000", &gAppleBootVariableGuid },
  //{ L"boot-args",            &gAppleBootVariableGuid },

  // FakeSMC Variables
  //{ L"fakesmc-key-$Num-ui8",  &gAppleBootVariableGuid }, { L"fakesmc-key-$Adr-ui32", &gAppleBootVariableGuid },
  //{ L"fakesmc-key-RMde-char", &gAppleBootVariableGuid }, { L"fakesmc-key-RPlt-ch8*", &gAppleBootVariableGuid },
  //{ L"fakesmc-key-RBr -ch8*", &gAppleBootVariableGuid }, { L"fakesmc-key-EPCI-ui32", &gAppleBootVariableGuid },
  //{ L"fakesmc-key-REV -ch8*", &gAppleBootVariableGuid }, { L"fakesmc-key-BEMB-flag", &gAppleBootVariableGuid },
  //{ L"fakesmc-key-BATP-flag", &gAppleBootVariableGuid }, { L"fakesmc-key-BNum-ui8",  &gAppleBootVariableGuid },
  //{ L"fakesmc-key-BBIN-ui8",  &gAppleBootVariableGuid }, { L"fakesmc-key-MSTc-ui8",  &gAppleBootVariableGuid },
  //{ L"fakesmc-key-MSAc-ui16", &gAppleBootVariableGuid }, { L"fakesmc-key-MSWr-ui8",  &gAppleBootVariableGuid },
  //{ L"fakesmc-key-MSFW-ui8",  &gAppleBootVariableGuid }, { L"fakesmc-key-MSPS-ui16", &gAppleBootVariableGuid },
  //{ L"fakesmc-key-#KEY-ui32", &gAppleBootVariableGuid },
};
